...
import DocumentConvertor.createpdf.adapter.BrushItemAdapter;
import DocumentConvertor.createpdf.adapter.ImageFiltersAdapter;
import DocumentConvertor.createpdf.interfaces.OnFilterItemClickedListener;
import DocumentConvertor.createpdf.interfaces.OnItemClickListener;
import DocumentConvertor.createpdf.model.BrushItem;
import DocumentConvertor.createpdf.model.FilterItem;
import DocumentConvertor.createpdf.util.BrushUtils;
import DocumentConvertor.createpdf.util.ImageFilterUtils;
import DocumentConvertor.createpdf.util.StringUtils;
import DocumentConvertor.createpdf.util.ThemeUtils;

import static DocumentConvertor.createpdf.util.Constants.IMAGE_EDITOR_KEY;
    ...
    private void saveCurrentImage() {
        try {
            ...
            String fileName = String.format(getString(R.string.filter_file_name),
                    System.currentTimeMillis(), mFilterName);
