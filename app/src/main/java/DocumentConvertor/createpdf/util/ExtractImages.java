...
import static DocumentConvertor.createpdf.util.FileUtils.getFileNameWithoutExtension;
import static DocumentConvertor.createpdf.util.ImageUtils.saveImage;
...
public class ExtractImages extends AsyncTask<Void, Void, Void> {
    ...
    protected void onPreExecute() {
     ...
     //Handling the Reading and checking for errors.
    @Override
